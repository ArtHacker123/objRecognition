...
rootOutputName = "TrainingSet/SegmentationFull/"
formatName = "*.png"
listDir = [];
	...
	for files in fileList:
		...
		for cnt in contours:
		    if cv2.contourArea(cnt)>500:
			    ...
			    if np.size(kp)>0:
			        cv2.imwrite(rootOutputName + listDir[dirCount] + str(dirCount*1000+ count*100 + counter*10) + ".png", roiImage)
			        print ("Path: " +rootOutputName + listDir[dirCount] + str(dirCount*1000+ count*100 + counter*10) + ".png")
